...
from app.routes.limits import router
...
_handler.setFormatter(_JsonFormatter("limits-service"))
...
app = FastAPI(title="Limits Service", version="0.1.0", lifespan=lifespan)
